...
export default function HiddenGemBlock({ g, index, isLast }) {
  const bgStyle = g.image_url
    ? { backgroundImage:`url(${g.image_url})`, backgroundSize:'cover', backgroundPosition:'center' }
  ...
  return (
    <div className="editorial-row" style={{
      ...
      <div className="editorial-image" style={{ flex:'0 0 38%', aspectRatio:'4/3', ...bgStyle }}/>
