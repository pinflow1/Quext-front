    ...
    <div style={{ position:'relative', height:'min(72vh,560px)', minHeight:420, overflow:'hidden', userSelect:'none' }}
      ...
      {a.image_url && (
        <div className="hero-poster" style={{
          position:'absolute', right:PAD, top:'50%', transform:'translateY(-50%)',
          width:'clamp(140px,26vw,220px)', aspectRatio:'225/318', borderRadius:10, overflow:'hidden',
          boxShadow:'0 24px 48px rgba(0,0,0,0.5)', border:'1px solid rgba(255,255,255,0.08)',
        }}>
      ...
      <div style={{ position:'absolute', left:0, bottom:0, right:0, padding:`0 ${PAD} 44px` }}>
        ...
        <h1 style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:700, fontSize:'clamp(1.8rem,6vw,3.6rem)', letterSpacing:'-0.02em', color:'var(--text)', margin:'0 0 10px', lineHeight:1.05, maxWidth:'60%' }}>{a.title}</h1>
        ...
        <p style={{ fontFamily:'Inter,sans-serif', fontSize:13, color:'var(--text-65)', maxWidth:'55%', lineHeight:1.6, marginBottom:22, display:'-webkit-box', WebkitLineClamp:2, WebkitBoxOrient:'vertical', overflow:'hidden' }}>{a.synopsis}</p>
