...
export default function CalendarUpcomingRow({ day, event, monthLabel, onSelect }) {
  return (
    ...
    onMouseLeave={e => e.currentTarget.style.background='transparent'}>
      ...
      <span style={{ fontFamily:"'IBM Plex Mono',monospace", fontSize:11, color:'var(--text-dim)', width:56, flexShrink:0 }}>{monthLabel} {day}</span>
      <div style={{ flex:1, minWidth:0 }}>
        <div style={{ fontFamily:'Inter,sans-serif', fontWeight:700, fontSize:14, color:'var(--text)', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>{event.title}</div>
      </div>
